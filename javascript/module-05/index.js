...
console.log('Результат 1', getAllNames(users)); // [ 'Moore Hensley', 'Sharlene Bush', 'Ross Vazquez', 'Elma Head', 'Carey Barr', 'Blackburn Dotson', 'Sheree Anthony' ]
...
console.log('Результат 2',getUsersByEyeColor(users, 'blue')); // [объект Moore Hensley, объект Sharlene Bush, объект Carey Barr]
...
console.log('Результат 3',getUsersByGender(users, 'male')); // [ 'Moore Hensley', 'Ross Vazquez', 'Carey Barr', 'Blackburn Dotson' ]
...
console.log('Результат 4', getInactiveUsers(users)); // [объект Moore Hensley, объект Ross Vazquez, объект Blackburn Dotson]
...
console.log('Результат 5.1', getUserByEmail(users, 'shereeanthony@kog.com')); // {объект пользователя Sheree Anthony}
console.log('Результат 5.2', getUserByEmail(users, 'elmahead@omatom.com')); // {объект пользователя Elma Head}
...
console.log('Результат 6.1', getUsersWithAge(users, 20, 30)); // [объект Ross Vazquez, объект Elma Head, объект Carey Barr]
                                            
console.log('Результат 6.2', getUsersWithAge(users, 30, 40)); 
...
console.log('Результат 7', getTotalBalance(users)); // 20916
...
const getUsersByFriend = (arr, name) => arr
                  .filter(user => user.friends.some(friend => friend === name))
                  .map(user => user.name);

console.log('Результат 8.1', getUsersByFriend(users, 'Briana Decker')); // [ 'Sharlene Bush', 'Sheree Anthony' ]
console.log('Результат 8.2', getUsersByFriend(users, 'Goldie Gentry')); // [ 'Elma Head', 'Sheree Anthony' ]